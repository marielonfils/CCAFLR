...
sys.path.append('../../../SEAL/native/src')
...
#PARAMETERS#
tracemalloc.start()
poly_mod_degree =4096 #8192
coeff_mod_bit_sizes = [40,20,40]#[60,40,40,60]#[40,20,40]
scale=2**40#2**20
...
def deallocate(vector):
    for i in range(len(vector)):
        vector[i]=None
    vector=None
poly_mod_degree,coeff_mod_bit_sizes,scale=None,None,None
N,l,s=None,None,None
contexts,secret_keys,public_keys=None,None,None
deallocate(plain_vectors)
#plain_vectors=None
aggregated_pk=None
encrypted_vectors=None
encrypted_sum=None
shares=None
decrypted,expected=None,None
